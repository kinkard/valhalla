...
// produces incomplete `multi_polygon`) if bbox is not fully covered by polygon - clipping a polygon might
// produce multiple polygons, and boost appears to process each polygon in the multi_polygon
